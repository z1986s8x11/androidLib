...
public class Lib_Widget_PhotoView extends ImageView implements IPhotoView {
    ...
    public Lib_Widget_PhotoView(Context context) {
        this(context, null);
    }

    public Lib_Widget_PhotoView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public Lib_Widget_PhotoView(Context context, AttributeSet attr, int defStyle) {
