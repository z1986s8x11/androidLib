 ...
 */
public class Lib_ViewPager_UnderlinePageIndicator extends View implements PageIndicator {
	...
	public Lib_ViewPager_UnderlinePageIndicator(Context context) {
		super(context);
		init(context);
	}

	public Lib_ViewPager_UnderlinePageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		_setFades(defaultFades);
		_setSelectedColor(defaultSelectedColor);
		_setFadeDelay(defaultFadeDelay);
		_setFadeLength(defaultFadeLength);
	...
	public boolean _getFades() {
		return mFades;
	}

	public void _setFades(boolean fades) {
		if (fades != mFades) {
			mFades = fades;
			if (fades) {
				post(mFadeRunnable);
	...
	public int _getFadeDelay() {
		return mFadeDelay;
	}

	public void _setFadeDelay(int fadeDelay) {
		mFadeDelay = fadeDelay;
	}

	public int _getFadeLength() {
		return mFadeLength;
	}

	public void _setFadeLength(int fadeLength) {
