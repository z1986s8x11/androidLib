 ...
 */
public class Lib_ViewPager_CirclePageIndicator extends View implements PageIndicator {
    ...
    public Lib_ViewPager_CirclePageIndicator(Context context) {
        super(context);
        init(context);
    }

    public Lib_ViewPager_CirclePageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public Lib_ViewPager_CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        int defaultPageColor = res.getColor(R.color.lib_transparent);
    ...
    public void _setPageColor(int pageColor) {
        mPaintPageFill.setColor(pageColor);
        invalidate();
    }

    public int _getPageColor() {
        return mPaintPageFill.getColor();
    }

    public void _setFillColor(int fillColor) {
        mPaintFill.setColor(fillColor);
        invalidate();
    }

    public int _getFillColor() {
    ...
    public void _setStrokeColor(int strokeColor) {
        mPaintStroke.setColor(strokeColor);
        invalidate();
    }

    public int _getStrokeColor() {
        return mPaintStroke.getColor();
    }

    public void _setStrokeWidth(float strokeWidth) {
     ...
     * 设置是否没有滑动动画效果
     */
    public void _setSnap(boolean snap) {
        mSnap = snap;
        invalidate();
    }

    public boolean _isSnap() {
        return mSnap;
    }
