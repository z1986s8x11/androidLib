 ...
 * are also scrolled.
 */
public class Lib_ViewPager_TitlePageIndicator extends View implements PageIndicator {
	/**
	...
	public Lib_ViewPager_TitlePageIndicator(Context context) {
		super(context);
		init(context);
	}

	public Lib_ViewPager_TitlePageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public Lib_ViewPager_TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(Context context) {
		...
		mFooterIndicatorStyle = IndicatorStyle
				.fromValue(defaultFooterIndicatorStyle);
		...
		mLinePosition = LinePosition.fromValue(defaultLinePosition);
	...
	public int _getFooterColor() {
		return mPaintFooterLine.getColor();
	}

	public void _setFooterColor(int footerColor) {
		mPaintFooterLine.setColor(footerColor);
		mPaintFooterIndicator.setColor(footerColor);
		invalidate();
	}

	public float _getFooterLineHeight() {
		return mFooterLineHeight;
	}

	public void _setFooterLineHeight(float footerLineHeight) {
		mFooterLineHeight = footerLineHeight;
		mPaintFooterLine.setStrokeWidth(mFooterLineHeight);
		invalidate();
	}

	public float _getFooterIndicatorHeight() {
		return mFooterIndicatorHeight;
	}

	public void _setFooterIndicatorHeight(float footerTriangleHeight) {
		mFooterIndicatorHeight = footerTriangleHeight;
		invalidate();
	}

	public float _getFooterIndicatorPadding() {
		return mFooterPadding;
	}

	public void _setFooterIndicatorPadding(float footerIndicatorPadding) {
		mFooterPadding = footerIndicatorPadding;
		invalidate();
	}

	public IndicatorStyle _getFooterIndicatorStyle() {
		return mFooterIndicatorStyle;
	}

	public void _setFooterIndicatorStyle(IndicatorStyle indicatorStyle) {
		mFooterIndicatorStyle = indicatorStyle;
		invalidate();
	}
	...
	public float _getTextSize() {
		return mPaintText.getTextSize();
	}

	public void _setTextSize(float textSize) {
		mPaintText.setTextSize(textSize);
		invalidate();
	}

	public float _getTitlePadding() {
		return this.mTitlePadding;
	}

	public void _setTitlePadding(float titlePadding) {
		mTitlePadding = titlePadding;
		invalidate();
	}

	public float _getTopPadding() {
		return this.mTopPadding;
	}

	public void _setTopPadding(float topPadding) {
		mTopPadding = topPadding;
		invalidate();
	}

	public float _getClipPadding() {
		return this.mClipPadding;
	}

	public void _setClipPadding(float clipPadding) {
		mClipPadding = clipPadding;
		invalidate();
	}

	public void _setTypeface(Typeface typeface) {
