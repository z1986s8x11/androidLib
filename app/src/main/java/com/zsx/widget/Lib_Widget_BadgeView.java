 ...
 * @author Jeff Gilfelt
 */
public class Lib_Widget_BadgeView extends TextView {
	...
	public Lib_Widget_BadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}

	public Lib_Widget_BadgeView(Context context, AttributeSet attrs) {
	 ...
	 */
	public Lib_Widget_BadgeView(Context context, View target) {
	 ...
	 */
	public Lib_Widget_BadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public Lib_Widget_BadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}

	public Lib_Widget_BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
	 ...
	 */
	public void _show(boolean animate) {
		_show(animate, fadeIn);
	}
	 ...
	 */
	public void _show(Animation anim) {
		_show(true, anim);
	}
	 ...
	 */
	public void _hide(boolean animate) {
	 ...
	 */
	public void _hide(Animation anim) {
		hide(true, anim);
	}
	 ...
	 */
	public void _toggle(boolean animate) {
	 ...
	 *            Animation to apply to the view when made non-visible.
	 */
	public void _toggle(Animation animIn, Animation animOut) {
		toggle(true, animIn, animOut);
	}

	@SuppressWarnings("deprecation")
	private void _show(boolean animate, Animation anim) {
	...
	private void toggle(boolean animate, Animation animIn, Animation animOut) {
		if (isShown) {
			...
			_show(animate && (animIn != null), animIn);
		}
	}
	 ...
	 * 
	 */
	public int _getHorizontalBadgeMargin() {
		return badgeMarginH;
	}
	 ...
	 * 
	 */
	public int _getVerticalBadgeMargin() {
		return badgeMarginV;
	}
	 ...
	 */
	public void _setBadgeMargin(int badgeMargin) {
	 ...
	 *            margin in pixels.
	 */
	public void _setBadgeMargin(int horizontal, int vertical) {
	 ...
	 * 
	 */
	public int _getBadgeBackgroundColor() {
		return badgeColor;
	}
	 ...
	 */
	public void _setBadgeBackgroundColor(int badgeColor) {
