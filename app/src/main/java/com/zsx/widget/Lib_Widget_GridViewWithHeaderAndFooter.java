...
public class Lib_Widget_GridViewWithHeaderAndFooter extends GridView {
    ...
    protected void initHeaderGridView() {
    }

    public Lib_Widget_GridViewWithHeaderAndFooter(Context context) {
        super(context);
        initHeaderGridView();
    }

    public Lib_Widget_GridViewWithHeaderAndFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public Lib_Widget_GridViewWithHeaderAndFooter(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = Lib_Widget_GridViewWithHeaderAndFooter.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = Lib_Widget_GridViewWithHeaderAndFooter.this.getMeasuredWidth()
                    - Lib_Widget_GridViewWithHeaderAndFooter.this.getPaddingLeft()
                    - Lib_Widget_GridViewWithHeaderAndFooter.this.getPaddingRight();
