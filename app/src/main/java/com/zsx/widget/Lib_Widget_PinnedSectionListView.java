 ...
 * 固定标题组的
 */
public class Lib_Widget_PinnedSectionListView extends ListView {
    public static abstract class PinnedSectionListAdapter<T> extends Lib_BaseAdapter<T> {
        public PinnedSectionListAdapter(Context context) {
            super(context);
        }

        public PinnedSectionListAdapter(Context context, List<T> list) {
            super(context, list);
        }
    ...
    public Lib_Widget_PinnedSectionListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public Lib_Widget_PinnedSectionListView(Context context,
    ...
    public void _setShadowVisible(boolean visible) {
        initShadow(visible);
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view,
                Lib_Widget_PinnedSectionListView.this);
        if (pinnedView == null)
            return;
    ...
    public void _setAdapter(PinnedSectionListAdapter adapter) {
        setAdapter(adapter);
    }
