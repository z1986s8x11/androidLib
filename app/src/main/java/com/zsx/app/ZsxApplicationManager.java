...
public class ZsxApplicationManager {
    ...
    public ZsxApplicationManager(Application context) {
        if (context == null) {
     ...
     * 设置是否监听网络变化
     */
    public ZsxApplicationManager setMonitorNet(boolean monitorNet) {
     ...
     * 设置是否启用捕获全局异常
     */
    public ZsxApplicationManager setUncaughtException(boolean uncaught) {
     ...
     * 设置存储数据的文件夹目录名称
     */
    public ZsxApplicationManager setFileManagerDir(String dir) {
