...
//public class PullLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild, IPull {
//
...
//            throw new RuntimeException("RefreshHead只能有一个");
//        }
//        mRefreshHead = head;
//        mRefreshHead.pullLayout(this);
//        if (null != mListener)
//            mLoadFooter.setOnPullListener(mListener);
//        addView(mRefreshHead.getTargetView());
//    }
//
//    public void attachFooterView(ILoadFooter footer) {
//        if (null != mLoadFooter) {
//            throw new RuntimeException("LoadFooter只能有一个");
//        }
//        mLoadFooter = footer;
...
//        if (null != mRefreshHead) {
//            mRefreshHead.setOnPullListener(listener);
//        }
//        if (null != mLoadFooter) {
//            mLoadFooter.setOnPullListener(listener);
//        }
