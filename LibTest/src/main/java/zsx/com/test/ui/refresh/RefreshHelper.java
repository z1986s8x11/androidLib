 ...
 */
//public class RefreshHelper implements OnScrollListener {
...
//            return;
//        }
//        headViewLayout = new LinearLayout(mAbsListView.getContext());
//        headViewLayout.setOrientation(LinearLayout.VERTICAL);
//        headViewLayout.setLayoutParams(new ViewGroup.LayoutParams(
...
//         * @return 是否成功加载到数据
//         */
//        void onRefresh(AutoListView listView);
//    }
//
//    /**
//     * 加载更多Listener
...
//         * 该方法会在在新线程中执行
//         *
//         * @param itemCount 当前显示的总数
//         * @return 是否成功加载到数据
//         */
//        void loadMoreData(AutoListView listView, int itemCount);
//
//        /**
//         * @param itemCount adapter的Count
//         * @return
//         */
...
//
//    /**
//     * @param delayTiem 加载完成之后 提示成功的View 持续显示的时间
//     */
